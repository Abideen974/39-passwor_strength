    ...
    <div className="form">
            ...
            <div className="bg-white rounded p-10 text-center shadow-md">
                ...
                <div className="my-4 text-left">
                    ...
                    <input type="text" className="border block w-full p-2 mt-2 rounded inputt" id="email" placeholder="Enter Email" />
                </div>
                <div className="my-4 text-left">
                    <label for="password" className="text-gray-900">Password:</label>
                    <input type="password" className="border block w-full p-2 mt-2 rounded inputt" id="password" ref={password}
                        placeholder="Enter Password" />
                </div>

                <button className="bg-black text-white py-2 mt-4 inline-block w-full rounded  btn" type="submit">Submit</button>
            </div>
    </div>
